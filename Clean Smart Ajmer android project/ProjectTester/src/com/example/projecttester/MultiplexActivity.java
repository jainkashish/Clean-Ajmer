...
public class MultiplexActivity extends Activity implements OnClickListener {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.multiplex, menu);
		return true;
	}
		...
		case R.id.button1:
			...
			b2.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					try {
						String address = "Maya Mandir  Jaipur Road";
	...
	case R.id.button2:
		...
		b22.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				try {
					String address = "Cine World  Ajmer  rajasthan";
					address = address.replace(' ', '+');
					Intent i = new Intent(android.content.Intent.ACTION_VIEW,
							Uri.parse("geo:0,0?q=" + address));
					startActivity(i);
	...
	case R.id.button3:
		...
		b222.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				try {
					String address = "Miraj Mall  Ajmer  rajasthan";
					address = address.replace(' ', '+');
					Intent i = new Intent(android.content.Intent.ACTION_VIEW,
							Uri.parse("geo:0,0?q=" + address));
					startActivity(i);
